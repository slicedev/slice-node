...
OAuthenticate.prototype.authenticateWithAuthCode = function (){
  var oauth = new OAuth2(this.client_id, this.client_secret, 'https://api.slice.com', null, '/oauth/token', {'redirect_uri': this.redirect_uri});
